            ...
            <div className="flex flex-col gap-3 p-4 border-t border-[#E7E8E3] bg-[#F8F8F6]">
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  ...
                  className="flex-1 inline-flex items-center justify-center px-4 py-3 bg-[#DFFF5E] text-[#1A1A1A] hover:bg-[#d4f54e] transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <button
                  ...
                  disabled={!broker.email}
                  className="flex-1 inline-flex items-center justify-center px-4 py-3 border border-[#E7E8E3] text-[#1A1A1A] hover:bg-white transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                >
