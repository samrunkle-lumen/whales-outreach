...
export function SatelliteView({ address, className = "" }: SatelliteViewProps) {
  ...
  if (!apiKey) {
    ...
    return (
      ...
      >
        <div className="w-16 h-16 bg-[#9FA38F]/20 rounded-full flex items-center justify-center mb-4">
          <svg className="w-8 h-8 text-[#9FA38F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
          </svg>
        </div>
        <p className="text-[#9FA38F] text-center text-sm mb-2">Satellite view available</p>
